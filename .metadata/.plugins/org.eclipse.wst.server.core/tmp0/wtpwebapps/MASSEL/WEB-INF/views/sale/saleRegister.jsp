...
<form action="/salePath/register" method="post" enctype="multipart/form-data">
				...
				<div class="title"> <!--제목div  -->
					<div>
						...
						<div class="titleinput">
						 	<input type="text" name="stitle" class="stitle" placeholder="상품 폼 제목을 입력해주세요.">
						 </div>
					</div>
				</div><!--제목div끝  -->
...
<!-- 				<div class="sellerInfoTitle">
			...
			<div class="sellerAccountInfo">
					<div class="bankNameDiv">
						...
						<input type="text" class="bankName" id="bankName" placeholder="은행이름을 입력해주세요.">
					</div>
					<div class="accountNumberDiv">
						<div class="accountText">계좌번호</div>
						<input type="text" class="accountNumber" id="accountNumber" placeholder="계좌번호를 입력해주세요.(숫자만 입력)">
					</div>
					<div class="accountHolderDiv">
						<div class="accountText">예금주</div>
						<input type="text" class="accountHolder" id="accountHolder" placeholder="예금주를 입력해주세요.">
					</div>
				</div> 
			</div>
