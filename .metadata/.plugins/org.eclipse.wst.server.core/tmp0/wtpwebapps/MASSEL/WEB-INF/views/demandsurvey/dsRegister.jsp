...
<form action="/demandSurvey/register" method="post" enctype="multipart/form-data">

<input type="hidden" name="id" value="${ses.uvo.id}"> <!--사용자 아이디 -->
<div>
<!-- @@@@@@@@@@@@@@@@수요조사 폼 시작@@@@@@@@@@@@@@@@  -->
				...
				<div class="title"> <!--제목div  -->
					<div>
						...
						<div class="titleinput">
						 	<input type="text" name="dtitle" class="dtitle" placeholder="수요조사 폼 제목을 입력해주세요.">
						 </div>
					</div>
				</div><!--제목div끝  -->
