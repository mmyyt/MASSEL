...
<form action="/salePath/modifySale" method="post" enctype="multipart/form-data">
				...
				<div class="title"> <!--제목div  -->
					<div>
						...
						<div class="titleinput">
						 	<input type="text" name="stitle" class="stitle" 
...
<div class="submitBtnWrapper">
    <button type="submit" onclick="sendProductList(); sendShippingMethod();" class="submitBtn">작성하기</button>
</div>
...
<!-- <button onclick="sendAccountInfo()">갑보내기</button> -->

<button onclick="sendShippingMethod()">값 보기</button>
