		...
		<div class="profileInfo">
			...
			<div class="profileInfoArea">
				...
				<div class="userImg">
					<div class="userImgArea">
							...
							<c:choose>
								<c:when test="${not empty ses.uivo }">
									<img alt="없음" class="profileImg" 
									src="/upload/userImg/${fn: replace(ses.uivo.saveDir, '\\','/')}/${ses.uivo.uuid }_${ses.uivo.fileName}">
								</c:when>
								<c:otherwise>
									<img class="profileImg" src="/resources/img/defaultUserImg.png" alt="">
								</c:otherwise>
							</c:choose>
					...
					<!-- <div class="imgEditBtnWrap"><button class="imgEditBtn">수정하기</button></div> -->
				</div>
...
<!-- 					<div class="emailBtnWrap">
						<button class="emailEditBtn">이메일 수정</button>
					</div> -->
				</div>
				<hr class="emailLine">
		...
		<div class="pwModal_content">
			...
			<div class="pwModalArea">
				...
				<div class="pwChangeBtn" onclick="pwUpdate()">
					<button class="pwChangeSubmit" id="pwChangeSubmit" onclick="pwUpdate()" disabled>수정</button>
				</div>
			</div>
		</div>
	</div> 
		...
		<div class="nicknameModal_content">
			...
			<div class="nicknameModalArea">
				...
				<div class="nicknameChangeBtn" onclick="nicknameUpdate()">
					<button class="nicknameChangeSubmit" id="nicknameChangeSubmit" onclick="nicknameUpdate()" disabled>수정</button>
				</div>
			</div>
		</div>
	</div> 
	...
	<div id="imgModal" class="imgModal">
		<div class="imgModal_content">
			...
			<div class="imgModalArea">
				<div class="imgModalContent">
					...
					<div class="imgChangeArea">
						...
						<div class="thumbnailImg" id="thumbnailImg">
							...
							<c:choose>
								<c:when test="${not empty ses.uivo }">
									<img alt="없음" class="thumbnailImg" 
									src="/upload/userImg/${fn: replace(ses.uivo.saveDir, '\\','/')}/${ses.uivo.uuid }_${ses.uivo.fileName}">
								</c:when>
								<c:otherwise>
									<img class="thumbnailImg" src="/resources/img/defaultUserImg.png" alt="">
								</c:otherwise>
							</c:choose>
				...
				<div class="imgChangeBtn" id="imgChangeBtn">
					<button class="imgChangeSubmit" id="imgChangeSubmit" disabled>수정</button>
				</div>
			</div>
			</form>
