...
<link rel="stylesheet" href="/resources/css/dsEdit.css">
...
<form action="/demandSurvey/edit" id="demandForm" method="post" enctype="multipart/form-data">
				...
				<div class="title"> <!--제목div  -->
					<div>
						...
						<div class="titleinput">
						 	<input type="text" name="dtitle" class="dtitle" id="dtitle"
...
<script>
	//let originalProductList = "${dsedto.dspvo}";

	//let jsonProductList = '<c:out value='${jsonProductList}' />';
